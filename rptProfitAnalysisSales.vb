...
Public Class rptProfitAnalysisSales
    ...
    <Browsable(false),  _
     DesignerSerializationVisibilityAttribute(System.ComponentModel.DesignerSerializationVisibility.Hidden)>  _
    Public ReadOnly Property Parameter_AnalysisID() As CrystalDecisions.[Shared].IParameterField
        Get
...
Public Class CachedrptProfitAnalysisSales
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As rptProfitAnalysisSales = New rptProfitAnalysisSales()
        rpt.Site = Me.Site
        Return rpt
    End Function
